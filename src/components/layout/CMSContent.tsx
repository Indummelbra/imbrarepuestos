...
const CMSContent: React.FC<CMSContentProps> = ({ title, content, type, modifiedGmt, lastSync }) => {
  ...
  useEffect(() => {
    const renderMarkdown = async () => {
      if (content) {
        try {
          // marked v17+ puede ser asíncrono por defecto
  ...
  return (
    <div className="article bg-white min-h-screen">
      <div className="imbra-content-container">
        {/* BANNER DE TÍTULO INDUSTRIAL IMBRA */}
        <div className="mb-12 border-l-8 border-primary pl-8 py-10 bg-[#212221] shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 
              className="imbra-h1 text-white break-words max-w-5xl !text-4xl md:!text-6xl"
        ...
        <div className="bg-white shadow-sm border border-gray-100 p-8 md:p-12 lg:p-20 relative min-h-[600px] mb-20">
