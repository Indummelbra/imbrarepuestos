            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                <h1 className="text-4xl lg:text-5xl font-Archivo font-black text-white italic tracking-tighter uppercase leading-none">
                  CHECKOUT <span className="text-primary text-2xl lg:text-3xl">SEGURO</span>
                </h1>
                <p className="text-gray-400 text-xs font-bold tracking-[0.3em] mt-2 uppercase">FINALIZA TU COMPRA INDUSTRIAL</p>
              </div>
              <div className="mt-6 md:mt-0 flex space-x-4">
                 ...
                 <div className="flex items-center space-x-2 bg-white/5 p-3 px-5 border border-white/10">
                    ...
                    <span className="text-[10px] font-bold text-white uppercase tracking-widest leading-none">PRODUCTOS<br/>ORIGINALES</span>
                 </div>
              </div>
            </div>
          </div>
